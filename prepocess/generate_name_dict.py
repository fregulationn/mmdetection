...
name_dict = "/home/junjie/Code/tianchi/guangdong/Label/ImageSets/Main/name.pickle"
...
names = ['纬缩', '烧毛痕', '花板跳', '跳花', '轧痕', '双纬', '吊经', '筘路', '断经', '毛粒', '污渍', '破洞', '松经', '浆斑', '三丝', '磨痕', '修痕', '稀密档', '粗经', '结头', '粗维', '百脚', '星跳', '水渍', '断氨纶', '死皱', '浪纹档', '油渍', '双经', '整经结', '纬纱不良', '云织', '色差档', '跳纱']
